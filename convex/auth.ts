    ...
    if (emailNormalized === "preview_trainee@mcci.com") {
      ...
      if (user === null) {
        ...
        await ctx.db.insert("coachingLogs", {
          ...
          coacheeInfo: "이몽룡",
          topic: "경청 및 질문 훈련",
          summary: "경청 훈련을 토대로 고객의 숨은 의도를 파악하는 코칭 진행",
          techniquesUsed: ["적극적 경청", "열린 질문"],
          clientInsight: "스스로가 가진 장점과 해결책을 구체화함",
          goals: "경청 기반의 커리어 탐색 피드백",
        ...
        await ctx.db.insert("coachingLogs", {
          userId,
          coachingDate: "2026-07-13",
          coachingStartTime: "10:00",
          coachingEndTime: "11:30",
          durationMinutes: 90,
          coachingType: "sv",
          sessionNumber: "1",
          coacheeInfo: "성춘향",
          topic: "GROW 모델 적용 실습",
          summary: "GROW 모델을 사용한 경력 목표 설정 및 현실 파악 훈련",
          techniquesUsed: ["GROW 모델", "경청"],
          clientInsight: "현실 상황의 장애물과 자원을 객관적으로 인지함",
          goals: "현실 탐색 및 실행 의지 다지기",
